...
В построенном графе ресурс **«Узметкомбинат»** представлен отдельным узлом,
не имеющим связей с другими ресурсами. Это означает, что при установленном
пороге `N = 2` программа не обнаружила ни одного другого ресурса, с которым
у него было бы не менее двух общих ключевых терминов.

Наличие отдельного узла является допустимым результатом алгоритма и отражает
особенность содержания данного информационного ресурса относительно
остальных ресурсов выборки.
